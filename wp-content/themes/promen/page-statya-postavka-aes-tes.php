...
<div class="pg">
  ...
  <div class="ar-split">
    <article class="ar-content">
      ...
      <p>Ниже — параметры поставок завода по объектам, которые различаются по классу, региону и статусу. Остальные объекты реестра — на странице «Проекты».</p>
      ...
      <div class="ar-proj-grid">
        ...
        <div class="ar-proj"><span class="ar-proj-t">АЭС «Руппур»</span><span class="ar-proj-l">Пабна, Бангладеш · АЭС</span><span class="ar-proj-v">Сталь 20 / 08Х18Н10Т · 2×ВВЭР‑1200</span></div>
      ...
      <p>Материал для АЭС-класса чаще всего — нержавеющая аустенитная сталь 08Х18Н10Т, как на Курской АЭС‑2 и «Аккую», и углеродистая сталь 20 для вспомогательных систем. Жаропрочная 15Х1М1Ф — сталь тепловой энергетики: на ВВЭР пар насыщенный, около 7 МПа и 286 °C, а 15Х1М1Ф нужна для паропроводов перегретого пара при 545–565 °C: именно её завод поставлял для перевооружения паропроводов Омской ТЭЦ‑3.</p>
      ...
      <p>Поставки на тепловую генерацию — как Черепетская ГРЭС (≈157 т, диапазон Ø25–530 мм) — чаще характеризуются большим объёмом номенклатуры при менее строгих требованиях к прослеживаемости, чем АЭС-класс. Материал обычно проще — углеродистая сталь 20, — а нормативная база опирается на СТО ЦКТИ, отраслевые ОСТ и ГОСТ без атомных норм НП.</p>
      ...
      <div class="ar-cmp">
        <div class="ar-cmp-col">
          ...
          <ul>
            ...
            <li>Нормы НП‑089‑15, НП‑104‑18, НП‑105‑18 поверх ГОСТ/ОСТ</li>
            <li>Материал — аустенитные нержавеющие и углеродистые стали</li>
          </ul>
        </div>
        <div class="ar-cmp-col">
