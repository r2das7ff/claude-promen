...
<div class="hero" id="hero">
  ...
  <div class="left">
    ...
    <!-- Где стоит производство. До 2026-09-03 город на главной не назывался
         нигде: только «ЧЛБ» в часах шапки (скрыты на мобильных) и адрес в
         футере. Без пояснений и ссылок — чип стоит вплотную к h1
         «Производство ДСЕ трубопроводов», и связка читается сама. -->
    <div class="hero-chip">Челябинск</div>
    ...
    <p class="body">
      Челябинский завод деталей и сборочных единиц трубопроводов
