<?php
/**
 * Контент категории «troyniki»: hero, карта типоисполнений, подбор, знания, модалка.
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product" data-label="Нужное исполнение">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17376-2001', $ctx['url'] ) ); ?>">К переходным в реестре →</a>
          </div>
          <div class="sg-params" data-label="Что передать для расчёта">
            <div class="sg-param-list">
...
<?php // Разметка FAQ собирается из этой же вёрстки, см. promen_faq_schema().
  promen_faq_schema( get_theme_file_path( 'inc/category-content/troyniki.php' ) ); ?>
