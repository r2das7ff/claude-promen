...
<section class="s10" id="request">
  <div class="s10-inner">
    <div class="s10-left">
      ...
      <?php /* Первый перенос отключается на планшете и телефоне (base.css):
               «Передайте нам» встаёт в строку, заголовок — в три строки
               вместо четырёх. Пробел после <br> нужен, чтобы при скрытом
               переносе слова не слиплись. */ ?>
      <h2 class="s10-h2">Передайте<br class="s10-h2-br"> нам<br>исходные<br>данные</h2>
