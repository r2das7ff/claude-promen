...
(function () {
  ...
  var CSS = ''
    ...
    + 'background:none;color:var(--dark);font-size:13px;cursor:pointer;transition:all .12s;}'
    + '.rm-close:hover{background:var(--dark);color:var(--white);}'
    + '.rm-eyebrow{display:flex;align-items:center;gap:12px;margin-bottom:22px;}'
    + '.rm-eye-num{font-family:"DINPro",monospace;font-size:9px;letter-spacing:.2em;'
    + 'color:var(--g1);border:1px solid var(--g1);padding:3px 8px;line-height:1;text-transform:uppercase;}'
    + '.rm-eye-label{font-family:"DINPro",monospace;font-size:9px;letter-spacing:.25em;'
    ...
    + '.rm-sub{font-family:"DINPro",sans-serif;font-size:12.5px;font-weight:300;'
    ...
    + '.rm-field-label{font-family:"DINPro",monospace;font-size:7.5px;letter-spacing:.2em;'
    ...
    + 'font-family:"DINPro",sans-serif;font-size:13px;font-weight:500;color:var(--dark);'
    ...
    + '.rm-field input::placeholder,.rm-field textarea::placeholder{color:var(--g2);font-weight:300;font-size:12px;}'
    + '.rm-field--wide{grid-column:span 2;}'
    + '.rm-file-row{margin-top:14px;display:flex;align-items:center;flex-wrap:wrap;gap:16px;}'
    + '.rm-file-label-txt{font-family:"DINPro",monospace;font-size:9px;letter-spacing:.2em;'
    ...
    + 'font-size:9.5px;letter-spacing:.12em;text-transform:uppercase;color:var(--g1);'
    ...
    + '.rm-file-name{font-family:"DINPro",monospace;font-size:10px;color:var(--g1);opacity:.7;}'
    ...
    + 'font-family:"DINPro",sans-serif;font-weight:700;font-size:12px;letter-spacing:.08em;'
    + 'text-transform:uppercase;cursor:pointer;transition:all .15s;}'
    + '.rm-submit:hover{background:var(--blue);border-color:var(--blue);}'
    + '.rm-submit[disabled]{opacity:.55;cursor:default;}'
    + '.rm-ghost-link{font-family:"DINPro",monospace;font-size:10px;letter-spacing:.1em;'
    ...
    + '.rm-note{font-family:"DINPro",monospace;font-size:8px;letter-spacing:.1em;color:var(--g1);'
    + 'opacity:.6;margin:12px 0 0;}'
    + '.rm-error{display:none;margin-top:14px;padding:12px 16px;border:1px solid var(--g1);'
    + 'font-family:"DINPro",monospace;font-size:10px;letter-spacing:.04em;line-height:1.5;color:var(--dark);'
    + 'background:rgba(109,140,166,.12);}'
    + '.rm-success{display:none;padding:22px 24px;background:rgba(109,140,166,.08);'
    + 'border:1px solid var(--g1);font-family:"DINPro",monospace;font-size:11px;'
    ...
    + '.rm-consent-txt{font-family:"DINPro",sans-serif;font-size:11px;line-height:1.5;color:var(--blue);}'
    ...
    + '.rm-eye-num,.rm-eye-label{font-size:10px;}'
    + '.rm-field-label{font-size:11px;}'
    + '.rm-field input,.rm-field textarea{font-size:16px;}' /* 16px — не даёт iOS зумить при фокусе */
    + '.rm-field input::placeholder,.rm-field textarea::placeholder{font-size:14px;}'
    + '.rm-file-label-txt{font-size:11px;}'
    + '.rm-file-btn{font-size:11px;min-height:44px;padding:12px 16px;}'
    + '.rm-file-name{font-size:11px;}'
    + '.rm-ghost-link{font-size:11px;min-height:44px;display:inline-flex;align-items:center;}'
    + '.rm-note{font-size:11px;}'
    + '.rm-submit{min-height:48px;}'
    + '.rm-consent{align-items:center;min-height:44px;}'
    + '.rm-consent input{width:22px;height:22px;}'
    + '.rm-consent-txt{font-size:13px;}}';
