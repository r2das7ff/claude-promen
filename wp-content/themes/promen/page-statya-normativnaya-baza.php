    ...
    <article class="ar-content">
      ...
      <div class="ar-quote">
        <p>«Нормативный документ объекта определяет не только форму детали, но и то, какой марки будет сталь, каким методом её проконтролируют и какие документы получит заказчик».</p>
            ...
            <h3>Основные документы по типам изделий</h3>
      <p>Наиболее применяемые нормативы каталога с диапазонами типоразмеров. Полный перечень — в <a href="/normativnaya-baza/">реестре нормативной базы</a>.</p>
<?php promen_norm_table( [ 'gost-17375-2001', 'gost-17376-2001', 'gost-17378-2001', 'gost-17379-2001', 'gost-33259-2015', 'gost-12820-1980', 'gost-8732-1978', 'gost-10704-1991', 'gost-7808-1970', 'gost-9064-1975' ] ); ?>
