...
<div class="pg">
  ...
  <div class="ar-split">
    <article class="ar-content">
      ...
      <p>Для объектов АЭС-класса добавляется ещё один слой — нормы и правила ПНАЭ и НП, регулирующие безопасность на объектах использования атомной энергии. Именно эти документы, наравне с маркой стали, определяют объём и метод контроля детали — вплоть до того, какой процент сварных швов подлежит 100% неразрушающему контролю. Подробнее о том, как устроен сам процесс контроля, — в статье <a href="<?php echo esc_url( promen_article_url( 'kontrol-kachestva' ) ); ?>" style="color:var(--dark);border-bottom:1px solid var(--g1);">«Контроль качества СДТ»</a>.</p>
