...
<div class="pg">
  ...
  <div class="clc-seo">
    ...
    <p>Для деталей по ГОСТ 17375-2001, ГОСТ 17376-2001, ГОСТ 17378-2001, ГОСТ 17379-2001, ГОСТ 30753-2001 и отраслевым ОСТ
    ...
    <ul>
      ...
      <li><a href="<?php echo esc_url( promen_product_cat_link( 'dnishcha' ) ); ?>">Днища</a> по ГОСТ 6533-78 и ОСТ 26-2040.</li>
    </ul>
