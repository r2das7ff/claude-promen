...
<div class="pg">
  ...
  <div class="ar-media">
    <picture><source srcset="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-7.webp' ) ); ?>" type="image/webp"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-7.jpg' ) ); ?>" alt="Формовка стальной трубы на производственной линии" loading="eager" width="1125" height="2000"></picture>
    ...
    <article class="ar-content">
      ...
      <div class="ar-quote">
        <p>«Выбор между бесшовным и сварным исполнением — это не вопрос цены, а вопрос диаметра, давления и нормативного документа объекта».</p>
            ...
            <h3>Нормативы на отводы в каталоге завода</h3>
      <p>Диапазоны и количество позиций — из действующего реестра, поэтому таблица показывает то, что завод выпускает сейчас, а не то, что допускает стандарт.</p>
<?php promen_norm_table( [ 'gost-17375-2001', 'gost-30753-2001', 'gost-22793-1983', 'ost-36-21-77', 'sto-321-05', 'sto-321-01' ] ); ?>
...
<h2 id="s5"><span class="num">05</span>Что выбрать под ваш проект</h2>
      ...
      <ul>
        ...
        <li><strong>Единичная партия по чертежу заказчика.</strong> Технология подбирается инженером под конкретную геометрию — см. статью об <a href="<?php echo esc_url( promen_article_url( 'chertezh-zakazchika' ) ); ?>">изготовлении по чертежам заказчика</a>.</li>
      </ul>
      <p>В любом случае финальное исполнение фиксируется в спецификации и согласовывается с заказчиком до запуска партии — марка стали для обоих исполнений подбирается по тем же принципам, что описаны в статье про <a href="<?php echo esc_url( promen_article_url( 'vybor-stali' ) ); ?>">выбор стали для СДТ</a>.</p>
  ...
  <div class="pd-sec">
    ...
    <div class="pd-rel-grid">
      ...
      <a class="pd-rel" href="<?php echo esc_url( promen_article_url( 'chertezh-zakazchika' ) ); ?>">
        <div class="pd-rel-media"><picture><source srcset="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-5.webp' ) ); ?>" type="image/webp"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-5.jpg' ) ); ?>" alt="Изготовление по чертежам заказчика" loading="lazy" width="2000" height="1500"></picture></div>
