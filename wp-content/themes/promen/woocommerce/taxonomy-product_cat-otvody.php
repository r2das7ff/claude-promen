<?php
/**
 * Страница категории категории «Отводы» — шаблон sdt.html второго уровня вложенности.
...
$otv_url  = $otv_link; // фильтры ?gost= на ЧПУ категории
$otv_cnt  = function_exists( 'promen_catalog_group_count' ) ? promen_catalog_group_count( 'otvody' ) : ( $otv ? (int) $otv->count : 0 );
?>
...
<?php promen_render_category_series_registry( 'otvody' ); ?>

<?php
// Живой реестр каталога (тот же partial, что на /catalog/).
promen_render_category_catalog_embed( 'otvody', (int) $otv_cnt );
?>
...
<?php promen_render_category_norms_section( 'otvody' ); ?>


<?php promen_render_materials_section( 'otvody' ); ?>
