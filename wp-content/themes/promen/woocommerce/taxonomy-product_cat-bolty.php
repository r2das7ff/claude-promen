<?php
/**
 * Страница категории «Болты» — семейство крепежа.
 * Ветка /catalog/krepezh/bolty/. Факты — aggregates / content/category/bolty.md.
 */
...
$otv      = get_term_by( 'slug', 'bolty', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'bolty', $shop_url );
  ...
  <div class="sdt-hero" id="hero">
    <div class="hero-left">
      ...
      <div class="hero-params">
        ...
        <div class="hp"><span class="hp-v">Б</span><span class="hp-k">Тип крепежа</span></div>
      </div>
    ...
    <div class="hero-right">
      <div class="hud-block">
        <div class="hud-label">Технические диапазоны / BOLTY SPECS</div>
        ...
        <div class="hud-row"><span class="hud-rk">Семейство</span><span class="hud-rv">Фундамент · шестигранные · ВП</span></div>
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / BOLTY</div>
    </div>
    ...
    <div id="regList">
      <div class="reg-group open" data-group="main">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          ...
          <span class="rg-name">Болты<small>семейство крепежа</small></span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22032-1976', $otv_url ) ); ?>">
        <span class="rr-i">БЛТ-22032</span>
        <span class="rr-n">Болт фундаментный<small>ГОСТ 22032</small></span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22043-1976', $otv_url ) ); ?>">
        <span class="rr-i">БЛТ-22043</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7796-1970', $otv_url ) ); ?>">
        <span class="rr-i">БЛТ-7796</span>
        <span class="rr-n">Болт с шестигранной головкой<small>ГОСТ 7796</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">904 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 7796-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7808-1970', $otv_url ) ); ?>">
        <span class="rr-i">БЛТ-7808</span>
        <span class="rr-n">Болт с уменьшенной головкой<small>ГОСТ 7808</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">904 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 7808-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10602-1994', $otv_url ) ); ?>">
        <span class="rr-i">БЛТ-10602</span>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр — болты →</a>
...
<section class="s map-outer" id="s02">
    ...
    <div class="map-body">
      <div class="map-root">
        <div class="map-root-label">Болты — исполнения семейства</div>
      </div>
...
<section class="s" id="s03">
    <div class="s-hd">
      <div class="s-badge"><span class="s-badge-num">03</span>Подбор — болты</div>
      <div class="s-meta">BOLTY / SELECTION GUIDE</div>
    </div>
    <div class="s-body">
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22032-1976', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7798-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7805-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10602-1994', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'bolty' ); ?>
...
<?php include __DIR__ . '/parts/kb-bolty.php'; ?>
...
<div class="order-modal" id="orderModal" role="dialog" aria-modal="true" aria-label="Заявка на болты">
  <div class="om-hd">
    <span class="om-sys">ПЭ-ФОРМА/КТЛ · ЗАЯВКА</span>
    <button class="om-close" id="orderClose" aria-label="Закрыть">✕</button>
  </div>
  <div class="om-title">Заявка на болты</div>
