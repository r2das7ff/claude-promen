<?php
/**
 * Страница категории «Шайбы» — семейство крепежа.
 * Ветка /catalog/krepezh/shayby/. Факты — aggregates / content/category/shayby.md.
 */
...
$otv      = get_term_by( 'slug', 'shayby', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'shayby', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / SHAYBY</div>
    </div>
    ...
    <div id="regList">
      <div class="reg-group open" data-group="main">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          ...
          <span class="rg-name">Шайбы<small>семейство крепежа</small></span>
          <span class="rg-params">M × L · 98 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-11371-1978', $otv_url ) ); ?>">
        <span class="rr-i">ШАЙ-11371</span>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр — шайбы →</a>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6402-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-11371-1978', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'shayby' ); ?>
...
<?php include __DIR__ . '/parts/kb-shayby.php'; ?>
