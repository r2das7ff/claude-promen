...
$otv_url  = $otv_link;
$otv_cnt  = function_exists( 'promen_catalog_group_count' ) ? promen_catalog_group_count( 'vinty' ) : ( $otv ? (int) $otv->count : 0 );
  ...
  <div class="sdt-hero" id="hero">
    ...
    <div class="hero-right">
      ...
      <div class="hud-block">
        ...
        <div class="hud-row"><span class="hud-rk">ГОСТ 11738-1984</span><span class="hud-rv live"><?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> поз.</span></div>
...
<?php promen_render_category_series_registry( 'vinty' ); ?>

<?php promen_render_category_catalog_embed( 'vinty', (int) $otv_cnt ); ?>
    ...
    <div class="map-body">
      ...
      <div class="map-groups" id="mapGroups" style="grid-template-columns:repeat(1,1fr);max-width:480px;">
        <div class="mg" data-type="main">
          <div class="mg-hd"><div class="mg-code">В</div><div class="mg-cnt"><?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> поз.</div></div>
          <div class="mg-name">Винты</div>
          <div class="mg-items">
            <div class="mg-item">По ГОСТ 11738<span class="mg-norm">ГОСТ 11738-1984</span></div>
          </div>
          <div class="mg-footer"><span class="mg-ftag">В</span><span class="mg-ftag"><?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> поз.</span></div>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-11738-1984', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
...
<?php promen_render_category_norms_section( 'vinty' ); ?>

<?php promen_render_materials_section( 'vinty' ); ?>
