<?php
/**
 * Страница категории «Заглушки» — шаблон sdt.html второго уровня.
 * Сгенерирована по PLAYBOOK-CATEGORY.md; факты — aggregates / ГОСТ 17379, 22815.
 */
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17379-2001', $otv_url ) ); ?>">К эллиптическим в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22815-1983', $otv_url ) ); ?>">К фланцевым в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( $otv_url ); ?>">К реестру заглушек →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php include __DIR__ . '/parts/kb-zaglushki.php'; ?>
