<?php
/**
 * Страница категории «Тройники» — шаблон sdt.html второго уровня.
 * Сгенерирована из taxonomy-product_cat-otvody.php по PLAYBOOK-CATEGORY.md.
 */
...
$otv      = get_term_by( 'slug', 'troyniki', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'troyniki', $shop_url ); // реестр отводов на корне каталога
  ...
  <div class="sdt-hero" id="hero">
    <div class="hero-left">
      ...
      <div class="hero-params">
        ...
        <div class="hp"><span class="hp-v">8 серий</span><span class="hp-k">По ГОСТ / ОСТ</span></div>
      </div>
...
<section class="s s-alt" id="s01">
    ...
    <div class="reg-bar" id="regBar">
      ...
      <span class="rb-count" id="regCount">8 серий · 491 позиция</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="tsh">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ТШ</span>
          <span class="rg-name">Штампованные приварные<small>бесшовные · равнопроходные и переходные</small></span>
          <span class="rg-params">DN 15–600 · штамповка</span>
          <span class="rg-cnt">96 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17376-2001', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-001</span>
        <span class="rr-n">Тройник бесшовный приварной<small>равнопроходный и переходный</small></span>
        <span class="rr-dn">15–600</span>
        <span class="rr-pn">96 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ГОСТ 17376-2001</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="tr1">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">Т-100</span>
          <span class="rg-name">На Ру до 100 МПа<small>высокое давление · с опорой и без</small></span>
          <span class="rg-params">DN 6–200 · Ру до 100 МПа</span>
          <span class="rg-cnt">222 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22801-1983', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-002</span>
        <span class="rr-n">Тройник на Ру до 100 МПа<small>детали трубопроводов высокого давления</small></span>
        <span class="rr-dn">6–200</span>
        <span class="rr-pn">103 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ГОСТ 22801-1983</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22822-1983', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-003</span>
        <span class="rr-n">Тройник с опорой<small>опорная пята · высокое давление</small></span>
        <span class="rr-dn">16–200</span>
        <span class="rr-pn">119 поз.</span>
        <span class="rr-m">09Г2С, 10Х17Н13М2Т, 12Х18Н10Т</span>
        <span class="rr-g">ГОСТ 22822-1983</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="tsv">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ТСВ</span>
          <span class="rg-name">Сварные для энергетики<small>ОСТ 34-10 · трубопроводы ТЭС</small></span>
          <span class="rg-params">DN 65–1600 · сварные</span>
          <span class="rg-cnt">140 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-762-97', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-004</span>
        <span class="rr-n">Тройник сварной ТЭС<small>равнопроходный</small></span>
        <span class="rr-dn">65–1600</span>
        <span class="rr-pn">33 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34.10.762-97</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-763-97', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-005</span>
        <span class="rr-n">Тройник сварной переходный<small>крупный DN</small></span>
        <span class="rr-dn">1000–1600</span>
        <span class="rr-pn">6 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34-10-763-97</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-764-97', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-006</span>
        <span class="rr-n">Тройник сварной ТЭС<small>основная серия</small></span>
        <span class="rr-dn">65–1600</span>
        <span class="rr-pn">99 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34-10-764-97</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-765-97', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-007</span>
        <span class="rr-n">Тройник сварной ТЭС<small>специальные исполнения</small></span>
        <span class="rr-dn">125–1200</span>
        <span class="rr-pn">2 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34-10-765-97</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="tts">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ТТС</span>
          <span class="rg-name">Тепловые сети<small>типовая серия</small></span>
          <span class="rg-params">DN до 950 · теплосети</span>
          <span class="rg-cnt">33 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'seriya-4-903-10', $otv_url ) ); ?>">
        <span class="rr-i">ТРО-008</span>
        <span class="rr-n">Тройник тепловых сетей<small>по типовой серии</small></span>
        <span class="rr-dn">до 950</span>
        <span class="rr-pn">33 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">СЕРИЯ 4.903-10</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр тройников →</a>
    </div>
  </section>
...
<section class="s map-outer" id="s02">
    ...
    <div class="map-body">
      <div class="map-root">
        <div class="map-root-label">Тройники — типоисполнения семейства</div>
      </div>
      <div class="map-groups" id="mapGroups" style="grid-template-columns:repeat(4,1fr);">
        ...
        <div class="mg" data-type="tsh">
          ...
          <div class="mg-items">
            ...
            <div class="mg-item">Бесшовные приварные<span class="mg-norm">DN 15–600</span></div>
          </div>
        ...
        <div class="mg" data-type="tr1">
          ...
          <div class="mg-items">
            ...
            <div class="mg-item">С опорой<span class="mg-norm">ГОСТ 22822-83</span></div>
            <div class="mg-item">Высокое давление<span class="mg-norm">DN 6–200</span></div>
          </div>
        ...
        <div class="mg" data-type="tsv">
          ...
          <div class="mg-items">
            ...
            <div class="mg-item">Крупные диаметры<span class="mg-norm">DN 65–1600</span></div>
            <div class="mg-item">НК сварных швов<span class="mg-norm">ВИК / УЗК / РК</span></div>
          </div>
          <div class="mg-footer"><span class="mg-ftag">DN 65–1600</span><span class="mg-ftag">ТЭС / ГРЭС</span></div>
        </div>
        <!-- ТЕПЛОСЕТИ -->
        <div class="mg" data-type="tts">
          ...
          <div class="mg-items">
            ...
            <div class="mg-item">Городские теплосети<span class="mg-norm">DN до 950</span></div>
            <div class="mg-item">ЖКХ и котельные<span class="mg-norm">типовые узлы</span></div>
          </div>
          <div class="mg-footer"><span class="mg-ftag">DN до 950</span><span class="mg-ftag">ЖКХ</span></div>
        </div>
      </div>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          <div class="sg-task">
            ...
            <div class="sg-task-h">Врезать ответвление равного диаметра (d = D)</div>
          </div>
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17376-2001', $otv_url ) ); ?>">К штампованным в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
              <div class="sg-param">DN и PN магистрали</div><div class="sg-param">D×s магистрали (напр. 219×8)</div><div class="sg-param">Марка стали и среда</div>
            </div>
          </div>
        </div>
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17376-2001', $otv_url ) ); ?>">К переходным в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
              <div class="sg-param">D×s магистрали и d×s ответвления</div><div class="sg-param">PN, марка стали</div><div class="sg-param">Объект: ТЭС / АЭС / нефтехим</div>
            </div>
          </div>
        </div>
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22801-1983', $otv_url ) ); ?>">К тройникам Ру 100 в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
              <div class="sg-param">Рабочее давление Ру и температура</div><div class="sg-param">Исполнение по стандарту</div><div class="sg-param">Наличие опоры, марка стали</div>
            </div>
          </div>
        </div>
        <div class="sg-row">
          <div class="sg-task">
            ...
            <div class="sg-task-h">Энергетический трубопровод ТЭС, крупный DN</div>
          </div>
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-764-97', $otv_url ) ); ?>">К сварным в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
              <div class="sg-param">D×s магистрали и ответвления</div><div class="sg-param">Объём НК сварных швов (ВИК / УЗК / РК)</div><div class="sg-param">Категория трубопровода</div>
            </div>
          </div>
        </div>
        <div class="sg-row">
          ...
          <div class="sg-product">
            <div class="sg-prod-name">Изготовление по КД заказчика — врезки, косые тройники, спецстали</div>
            <div class="sg-tags">
          ...
          <div class="sg-params">
            <div class="sg-param-list">
              <div class="sg-param">Чертёж или эскиз с размерами</div><div class="sg-param">Среда, давление, температура</div><div class="sg-param">Количество и срок поставки</div>
            </div>
          </div>
        </div>
      </div>
...
<section class="s s-dark" id="s04">
    ...
    <div class="s-body" style="padding-top:28px;">
      <div class="norm-tab-bar reveal" id="normTabs">
        <button class="nt" data-ng="otv">Отводы</button>
        <button class="nt on" data-ng="troy">Тройники</button>
      ...
      <!-- ОТВОДЫ -->
      <div class="norm-group" id="ng-otv">
      ...
      <!-- ТРОЙНИКИ -->
      <div class="norm-group nactive" id="ng-troy">
