...
$otv_url  = $otv_link;
$otv_cnt  = function_exists( 'promen_catalog_group_count' ) ? promen_catalog_group_count( 'troyniki' ) : ( $otv ? (int) $otv->count : 0 );
?>
...
<?php promen_render_category_series_registry( 'troyniki' ); ?>

<?php promen_render_category_catalog_embed( 'troyniki', (int) $otv_cnt ); ?>
...
<?php promen_render_category_norms_section( 'troyniki' ); ?>


<?php promen_render_materials_section( 'troyniki' ); ?>
