<?php
/**
 * Страница категории «Точеные детали» — переходы точеные детали (ПТ).
 * Отдельная ветка /catalog/tochenye/. Факты — CSV new_products_from_az.
 */
...
$otv      = get_term_by( 'slug', 'tochenye', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'tochenye', $shop_url );
  ...
  <div class="sdt-hero" id="hero">
    <div class="hero-left">
      ...
      <div class="hero-params">
        ...
        <div class="hp"><span class="hp-v">ПТ</span><span class="hp-k">Тип · исп. 1–5</span></div>
      </div>
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / TOCHENYE</div>
    </div>
    <div class="reg-bar" id="regBar">
      <span class="rb-lbl">Серии нормативов</span>
      <span class="rb-lbl" style="opacity:.55;">2 серии · клик открывает фильтр реестра</span>
      <span class="rb-count" id="regCount">ПТ · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="pt">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          ...
          <span class="rg-name">Переходы точеные детали<small>механическая обработка</small></span>
          <span class="rg-params">DN 10–200 · исп. 1–5</span>
          <span class="rg-cnt"><?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22826-1983', $otv_url ) ); ?>">
        <span class="rr-i">ТЧН-22826</span>
        <span class="rr-n">Переход точёный<small>ГОСТ 22826 · исп. 1–5</small></span>
        <span class="rr-dn">10–200</span>
        <span class="rr-pn">89 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-42-664-84', $otv_url ) ); ?>">
        <span class="rr-i">ТЧН-664</span>
        <span class="rr-n">Переход точёный<small>ОСТ 34-42-664</small></span>
        <span class="rr-dn">по ряду</span>
        <span class="rr-pn">10 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ОСТ 34-42-664-84</span>
        <span class="rr-t"><span class="rr-tag hi">Энергетика</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр точёных →</a>
    </div>
  </section>
...
<section class="s map-outer" id="s02">
    ...
    <div class="map-body">
      <div class="map-root">
        <div class="map-root-label">Точеные детали — типоисполнения семейства</div>
      </div>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22826-1983', $otv_url ) ); ?>">К ГОСТ 22826 в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-42-664-84', $otv_url ) ); ?>">К ОСТ 664 в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'tochenye' ); ?>
...
<?php include __DIR__ . '/parts/kb-tochenye.php'; ?>
...
<div class="order-modal" id="orderModal" role="dialog" aria-modal="true" aria-label="Заявка на точеные детали">
  <div class="om-hd">
    <span class="om-sys">ПЭ-ФОРМА/КТЛ · ЗАЯВКА</span>
    <button class="om-close" id="orderClose" aria-label="Закрыть">✕</button>
  </div>
  <div class="om-title">Заявка на точеные детали</div>
