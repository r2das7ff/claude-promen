<?php
/**
 * Страница категории «Изоляция и покрытия» — фасонные в ППУ.
 * Ветка /catalog/izolyatsiya/. Факты — CSV new_products_from_az (нормализованный).
 */
...
$otv      = get_term_by( 'slug', 'izolyatsiya', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'izolyatsiya', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / IZOLYATSIYA</div>
    </div>
    <div class="reg-bar" id="regBar">
      <span class="rb-lbl">Типоисполнения</span>
      <span class="rb-lbl" style="opacity:.55;">2 группы · клик по заголовку сворачивает</span>
      <span class="rb-count" id="regCount">Тройники ППУ · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="pe">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ПЭ</span>
          <span class="rg-name">Оболочка полиэтиленовая<small>бесканальная прокладка</small></span>
          <span class="rg-params">ГОСТ 30732-2020</span>
          <span class="rg-cnt">37 поз.</span>
      ...
      <a class="reg-r" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-30732-2020', $otv_url ) ); ?>">
        <span class="rr-i">ИЗЛ-ПЭ</span><span class="rr-n">Тройник ППУ ПЭ<small>полиэтиленовая оболочка</small></span>
        <span class="rr-dn">D 530–1020</span><span class="rr-pn">37 поз.</span><span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 30732-2020</span><span class="rr-t"><span class="rr-tag hi">Теплосети</span></span><span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="oc">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ОЦ</span>
          <span class="rg-name">Оболочка оцинкованная<small>канальная / надземная</small></span>
          <span class="rg-params">ГОСТ 30732-2020</span>
        ...
        <div class="reg-group-body">
      <a class="reg-r" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-30732-2020', $otv_url ) ); ?>">
        <span class="rr-i">ИЗЛ-ОЦ</span><span class="rr-n">Тройник ППУ ОЦ<small>оцинкованная оболочка</small></span>
        <span class="rr-dn">D 530–1020</span><span class="rr-pn">35 поз.</span><span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 30732-2020</span><span class="rr-t"><span class="rr-tag hi">Теплосети</span></span><span class="rr-arr">›</span>
      </a>
        </div>
      </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр изоляции →</a>
    </div>
  </section>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product"><div class="sg-prod-name">Тройник ППУ ПЭ ГОСТ 30732</div>
            ...
            <a class="sg-link" href="<?php echo esc_url( $otv_url ); ?>">К реестру →</a></div>
        ...
        <div class="sg-row">
          ...
          <div class="sg-product"><div class="sg-prod-name">См. раздел «Трубы» · тип ППУ</div>
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'group', 'truby', $shop_url ) ); ?>">К трубам ППУ →</a></div>
...
<section class="s s-dark" id="s04">
    <div class="s-hd">
      ...
      <div class="s-meta">REGULATORY REGISTRY / IZOLYATSIYA</div>
    </div>
    <div class="s-body" style="padding-top:28px;">
      <div class="norm-tab-bar reveal" id="normTabs">
        <button class="nt on" data-ng="ppu">ГОСТ 30732</button>
        <button class="nt" data-ng="net">Теплосети</button>
        <button class="nt" data-ng="gen">Общие</button>
      </div>
      <div class="norm-group nactive" id="ng-ppu">
        <div class="ng-label">Нормативная база — ППУ-изоляция</div>
        <div class="norm-grid2 cols-1">
          <div class="nc reveal">
            ...
            <div class="nc-desc">Основной стандарт каталога изоляции. В витрине — тройники ППУ с оболочкой ПЭ или ОЦ, <strong>72 позиции</strong>. Геометрия стальной части, толщина изоляции и оболочка — по таблицам ГОСТ и проекту сети.</div>
            <div class="nc-tags"><span class="nc-tag">ППУ</span><span class="nc-tag">72 поз.</span><span class="nc-tag">Действующий</span></div>
            ...
            <div class="nc-full"><div class="nc-full-items">
              ...
              <div class="nc-full-item">Система оперативного дистанционного контроля (ОДК) — по проекту</div>
              <div class="nc-full-item">Комплектность: стальная деталь + ППУ + оболочка</div>
            </div></div>
            <div class="nc-status"><div class="nc-dot"></div>Действующий / 2020</div>
          </div>
        </div>
      </div>
      <div class="norm-group" id="ng-net">
        <div class="ng-label">Нормативная база — Тепловые сети</div>
        <div class="norm-grid2 cols-1">
          <div class="nc reveal">
            <div class="nc-code">СП 124.13330</div>
            <div class="nc-title">Тепловые сети</div>
            <div class="nc-desc">Свод правил по проектированию и строительству тепловых сетей. Определяет тип прокладки (бесканальная / канальная / надземная) и требования к предизолированным изделиям.</div>
            <div class="nc-tags"><span class="nc-tag">СП</span><span class="nc-tag">Теплосети</span></div>
      ...
      <div class="norm-group" id="ng-gen">
        ...
        <div class="norm-grid2">
          <div class="nc reveal">
            ...
            <div class="nc-desc">Применяется к стальной части изделия при работе под избыточным давлением свыше 0,05 МПа.</div>
          ...
          <div class="nc reveal">
            ...
            <div class="nc-desc">ТУ 24.20.40-001-13842829-2023 — комплектность поставки, маркировка и объём контроля.</div>
    ...
    <div class="prod-layout reveal">
      <div class="prod-main">
        ...
        <div class="prod-caps">
          ...
          <div class="pc"><div class="pc-h">Сварные конструкции</div><p class="pc-p">Фасонные изделия в ППУ: тройники с оболочкой ПЭ или ОЦ по ГОСТ 30732. ГОСТ 30732-2020 · тепловые сети.</p></div>
...
<?php include __DIR__ . '/parts/kb-izolyatsiya.php'; ?>
