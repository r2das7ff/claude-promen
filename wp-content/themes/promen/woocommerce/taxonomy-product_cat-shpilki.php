...
$otv_url  = add_query_arg( 'group', 'shpilki', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / SHPILKI</div>
    </div>
    ...
    <div id="regList">
      <div class="reg-group open" data-group="main">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          ...
          <span class="rg-name">Шпильки<small>семейство крепежа</small></span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-15590-1970', $otv_url ) ); ?>">
        <span class="rr-i">ШПЛ-15590</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-15591-1970', $otv_url ) ); ?>">
        <span class="rr-i">ШПЛ-15591</span>
        <span class="rr-n">Шпилька<small>ГОСТ 15591</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">240 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 15591-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10494-1980', $otv_url ) ); ?>">
        <span class="rr-i">ШПЛ-10494</span>
        <span class="rr-n">Шпилька Ст20<small>ГОСТ 10494</small></span>
        <span class="rr-dn">M×L</span>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр — шпильки →</a>
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'shpilki' ); ?>
