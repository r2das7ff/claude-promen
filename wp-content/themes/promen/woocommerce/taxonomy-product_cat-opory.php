...
$otv_url  = add_query_arg( 'group', 'opory', $shop_url );
$otv_cnt  = 0;
$_opory_nepodv = get_term_by( 'slug', 'opory-nepodv', 'product_cat' );
$otv_cnt += $_opory_nepodv ? (int) $_opory_nepodv->count : 0;
$_opory_skolz = get_term_by( 'slug', 'opory-skolz', 'product_cat' );
$otv_cnt += $_opory_skolz ? (int) $_opory_skolz->count : 0;
$_opory_pruzh = get_term_by( 'slug', 'opory-pruzh', 'product_cat' );
$otv_cnt += $_opory_pruzh ? (int) $_opory_pruzh->count : 0;
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / OPORY</div>
    </div>
    ...
    <div id="regList">
      <div class="reg-group open" data-group="np">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">НП</span>
          <span class="rg-name">Неподвижные<small>хомутовые</small></span>
          <span class="rg-params">ОСТ 36-17-85</span>
          <span class="rg-cnt"><?php echo esc_html( (string) $n_np ); ?> поз.</span>
      ...
      <a class="reg-r" href="<?php echo esc_url( add_query_arg( 'group', 'opory-nepodv', $shop_url ) ); ?>">
        <span class="rr-i">ОПР-НП</span><span class="rr-n">Опора неподвижная<small>хомутовая</small></span>
        <span class="rr-dn">50–1000</span><span class="rr-pn"><?php echo esc_html( (string) $n_np ); ?> поз.</span><span class="rr-m">Ст3сп</span>
        <span class="rr-g">ОСТ 36-17-85</span><span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">Пром</span></span><span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="sk">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">СК</span>
          <span class="rg-name">Скользящие<small>с антифрикционным слоем</small></span>
          <span class="rg-params">ОСТ 36-17-85</span>
          <span class="rg-cnt"><?php echo esc_html( (string) $n_sk ); ?> поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" href="<?php echo esc_url( add_query_arg( 'group', 'opory-skolz', $shop_url ) ); ?>">
        <span class="rr-i">ОПР-СК</span><span class="rr-n">Опора скользящая<small>компенсация перемещений</small></span>
        <span class="rr-dn">50–800</span><span class="rr-pn"><?php echo esc_html( (string) $n_sk ); ?> поз.</span><span class="rr-m">Ст3сп</span>
        <span class="rr-g">ОСТ 36-17-85</span><span class="rr-t"><span class="rr-tag hi">Теплосети</span></span><span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="pr">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ПР</span>
          <span class="rg-name">Пружинные<small>опоры / подвески</small></span>
          <span class="rg-params">ОСТ 36-17-85</span>
          <span class="rg-cnt"><?php echo esc_html( (string) $n_pr ); ?> поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" href="<?php echo esc_url( add_query_arg( 'group', 'opory-pruzh', $shop_url ) ); ?>">
        <span class="rr-i">ОПР-ПР</span><span class="rr-n">Опора пружинная<small>вертикальные нагрузки</small></span>
        <span class="rr-dn">50–500</span><span class="rr-pn"><?php echo esc_html( (string) $n_pr ); ?> поз.</span><span class="rr-m">Ст20</span>
        <span class="rr-g">ОСТ 36-17-85</span><span class="rr-t"><span class="rr-tag">Энергетика</span></span><span class="rr-arr">›</span>
      </a>
        </div>
      </div>
    </div>
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр опор →</a>
    </div>
  </section>
...
<section class="s s-dark" id="s04">
    <div class="s-hd">
      ...
      <div class="s-meta">REGULATORY REGISTRY / OPORY</div>
    </div>
    <div class="s-body" style="padding-top:28px;">
      <div class="norm-tab-bar reveal" id="normTabs">
        <button class="nt on" data-ng="ost">ОСТ 36-17</button>
        <button class="nt" data-ng="gen">Общие</button>
      </div>
      <div class="norm-group nactive" id="ng-ost">
        <div class="ng-label">Нормативная база — Опоры и подвески</div>
        <div class="norm-grid2 cols-1">
          <div class="nc reveal">
            <div class="nc-code">ОСТ 36-17-85</div>
            <div class="nc-title">Опоры и подвески трубопроводов промышленных предприятий</div>
            <div class="nc-desc">Основной норматив каталога опор. Неподвижные, скользящие и пружинные исполнения. Подбор по DN трубы, типу крепления и расчётной нагрузке.</div>
            <div class="nc-tags"><span class="nc-tag">Опоры</span><span class="nc-tag"><?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> поз.</span><span class="nc-tag">Действующий</span></div>
            <button class="nc-expand-btn" onclick="toggleNc(this)">+ ещё нормативы</button>
            <div class="nc-full"><div class="nc-full-items">
              <div class="nc-full-item">ОСТ 36-17-85 — опоры и подвески промышленных трубопроводов</div>
              <div class="nc-full-item">СТО ЦКТИ / проектные нормы — по объекту</div>
              <div class="nc-full-item">ТУ 24.20.40-001-13842829-2023 — ТУ предприятия</div>
            </div></div>
            <div class="nc-status"><div class="nc-dot"></div>Действующий / 1985</div>
          </div>
        </div>
      </div>
      <div class="norm-group" id="ng-gen">
        ...
        <div class="norm-grid2">
          <div class="nc reveal">
            ...
            <div class="nc-desc">Применяется к трубопроводу объекта; опоры — часть комплекта поставки трассы.</div>
          ...
          <div class="nc reveal">
            ...
            <div class="nc-desc">Комплектность, маркировка и объём контроля при поставке опор.</div>
