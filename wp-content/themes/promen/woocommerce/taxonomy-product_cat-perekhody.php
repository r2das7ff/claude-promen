<?php
/**
 * Страница категории «Переходы» — шаблон sdt.html второго уровня.
 * Сгенерирована по PLAYBOOK-CATEGORY.md; факты — aggregates / norm_aggregates / ГОСТ.
 */
...
$otv      = get_term_by( 'slug', 'perekhody', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'perekhody', $shop_url ); // реестр переходов на корне каталога
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / PEREKHODY</div>
    </div>
    <div class="reg-bar" id="regBar">
      ...
      <span class="rb-count" id="regCount">6 серий · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="psh">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ПШ</span>
          <span class="rg-name">Бесшовные приварные<small>концентрические и эксцентрические</small></span>
          <span class="rg-params">DN 32–600 · штамповка</span>
          <span class="rg-cnt">278 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17378-2001', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-001</span>
        <span class="rr-n">Переход бесшовный приварной<small>концентрический и эксцентрический</small></span>
        <span class="rr-dn">32–600</span>
        <span class="rr-pn">278 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ГОСТ 17378-2001</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="p100">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">П-100</span>
          <span class="rg-name">На Ру до 100 МПа<small>высокое давление · нефтехимия</small></span>
          <span class="rg-params">DN 25–200 · Ру до 100 МПа</span>
          <span class="rg-cnt">68 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22826-1983', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-002</span>
        <span class="rr-n">Переход на Ру до 100 МПа<small>детали трубопроводов высокого давления</small></span>
        <span class="rr-dn">25–200</span>
        <span class="rr-pn">68 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20ХЗМВФ</span>
        <span class="rr-g">ГОСТ 22826-1983</span>
        <span class="rr-t"><span class="rr-tag hi">АЭС</span><span class="rr-tag">Нефтехим</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="psv">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ПСВ</span>
          <span class="rg-name">Сварные крупный DN<small>ОСТ 36 / ОСТ 34-10 · ТЭС</small></span>
          <span class="rg-params">DN 300–1600 · сварные</span>
          <span class="rg-cnt">57 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-36-22-77', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-003</span>
        <span class="rr-n">Переход сварной<small>Dy 500–1400 · Ру ≤ 2,5 МПа</small></span>
        <span class="rr-dn">500–1400</span>
        <span class="rr-pn">33 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 36-22-77</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">ГРЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-753-97', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-004</span>
        <span class="rr-n">Переход сварной листовой ТЭС<small>Рраб &lt; 2,2 МПа</small></span>
        <span class="rr-dn">300–1600</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34-10-753-97</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">АЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="pt">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ПТ</span>
          <span class="rg-name">Точёные и мелкий DN<small>СТО ЦКТИ / ОСТ 34-10</small></span>
          <span class="rg-params">DN 15–65 · точение / сварка</span>
          <span class="rg-cnt">22 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'sto-318-01', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-005</span>
        <span class="rr-n">Переход ЦКТИ 318.01<small>точёный · исполнения 01–03</small></span>
        <span class="rr-dn">15–65</span>
        <span class="rr-pn">13 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">СТО 318.01</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">Котельные</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-34-10-754-97', $otv_url ) ); ?>">
        <span class="rr-i">ПЕР-006</span>
        <span class="rr-n">Переход сварной ТЭС<small>мелкий DN · ОСТ 34.10.754</small></span>
        <span class="rr-dn">15–40</span>
        <span class="rr-pn">9 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 13ХФА</span>
        <span class="rr-g">ОСТ 34.10.754-97</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">АЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр переходов →</a>
    </div>
  </section>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17378-2001', $otv_url ) ); ?>">К бесшовным в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-17378-2001', $otv_url ) ); ?>">К эксцентрическим в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22826-1983', $otv_url ) ); ?>">К переходам Ру 100 в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-36-22-77', $otv_url ) ); ?>">К сварным в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'perekhody' ); ?>
...
<?php include __DIR__ . '/parts/kb-perekhody.php'; ?>
