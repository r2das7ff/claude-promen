...
<section class="cat-seo">
  ...
  <div class="seo-body">
    <div class="seo-title-col">
      ...
      <?php /* Слово целиком, без переноса дефисом: «Трубо-<br>проводные»
               поисковик и скринридер читают как два слова, и ключевой
               термин страницы из заголовка пропадал. */ ?>
      <h2 class="seo-h2">Трубопроводные<br>изделия для<br><em>АЭС</em> и <em>ТЭС</em></h2>
    </div>
    <div class="seo-text-col">
      ...
      <p class="seo-p">Диапазон типоразмеров: <strong>DN 15–1400 мм, PN 0.6–20.0 МПа, рабочая температура −40…+600°С</strong>. Поставка единичными изделиями и серийными партиями, а также комплектами по проектной документации заказчика. Изготовление по ГОСТ, ОСТ, СТО, СТО ЦКТИ, СТО СРО-П, НП и конструкторской документации. Каждое изделие сопровождается <strong>паспортом качества 3.1 по ГОСТ ISO 10474-2016</strong>, сертификатами на металл с плавочными данными и протоколами контроля. Продукция декларирована по ТР ТС 032/2013.</p>
      <p class="seo-p">Для объектов атомной энергетики: <strong>НП-104-18</strong> (сварка и наплавка оборудования и трубопроводов АЭУ), <strong>НП-068-05</strong> (арматура атомных станций), <strong>НП-089-15</strong> (общие требования к оборудованию и трубопроводам). Прослеживаемость металла от плавки до готового изделия подтверждается документально по всей производственной цепочке.</p>
    </div>
  </div>
  ...
  <div class="seo-specs">
    ...
    <div class="seo-spec-col">
      <div class="seo-spec-item">
        ...
        <span class="seo-spec-v"><?php echo promen_spec_value( 'ГОСТ · ОСТ · СТО ЦКТИ 321/720 · НП-045-18 · НП-089-15 · НП-104-18 · НП-068-05 · ТУ · КД' ); ?></span>
      </div>
      <div class="seo-spec-item">
