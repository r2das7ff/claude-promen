...
<!-- S10: БАЗА ЗНАНИЙ — ПЕРЕХОДЫ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">ПЕРЕХОДЫ</div>
    </div>

    <div class="kb-tabrow" role="tablist">
      <button class="kb-tab active" data-panel="types" role="tab"><span class="kb-tab-n">01</span>Виды переходов</button>
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        <div class="kb-lead">
          <div class="kb-lead-h">Классификация переходов</div>
          <p class="kb-lead-p">Переход стыкует участки трубопровода разных диаметров с сохранением прочности стыка и заданной гидравлики. В каталоге — <strong>четыре типоисполнения</strong>, <strong>425 типоразмеров</strong> по шести сериям: концентрические (<strong>ПК</strong>), эксцентрические (<strong>ПЭ</strong>) и точёные (<strong>ПТ</strong>). Выбор — по давлению, DN, методу изготовления и нормативу объекта.</p>
        </div>
      ...
      <div class="kb-panel" id="kp-params">
        ...
        <div class="kb-2col">
          <div>
            <div class="kb-col-title">Чеклист заявки на переход</div>
          ...
          <div>
            <div class="kb-col-title">Ключевые параметры перехода</div>
            <div class="kb-params">
