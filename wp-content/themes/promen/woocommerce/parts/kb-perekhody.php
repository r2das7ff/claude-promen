...
<!-- S10: БАЗА ЗНАНИЙ — ПЕРЕХОДЫ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">KNOWLEDGE BASE / ПЕРЕХОДЫ</div>
    </div>
        ...
        <div class="kb-norm-grid">
          ...
          <div class="kb-norm-group">
            ...
            <div class="kb-norm-items">
              ...
              <div class="kb-norm-item"><span class="kb-norm-code">СТО 318.01-2009</span><span class="kb-norm-desc">Переходы точёные ЦКТИ, исполнения 01–03. 13 позиций</span></div>
            </div>
          </div>
          <div class="kb-norm-group">
