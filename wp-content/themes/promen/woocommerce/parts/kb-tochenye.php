...
<!-- S10: БАЗА ЗНАНИЙ — ПЕРЕХОДЫ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">ТОЧЕНЫЕ ДЕТАЛИ</div>
    </div>
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        <div class="kb-lead">
          ...
          <p class="kb-lead-p">Точеные детали переходы (тип <strong>ПТ</strong>) изготавливаются механической обработкой по <strong>ГОСТ 22826-83</strong> (89 позиций) и <strong>ОСТ 34-42-664-84</strong> (10 позиций). В каталоге — <strong>99 типоразмеров</strong>, DN 10–200, исполнения 1–5. Подбор по D×s / d×s (или DN), исполнению и марке стали.</p>
        </div>
        ...
        <div class="kb-cards">
          ...
          <div class="kb-card">
            ...
            <p class="kb-card-body">Точеные детали переходы по СТО ЦКТИ 318.01-2009 (исполнения 01–03) и сварные мелкого DN по ОСТ 34-10-754-97. Котельные обвязки, малые диаметры, точная геометрия. <strong>22 позиции</strong>.</p>
        ...
        <div class="kb-3col">
          ...
          <div>
            ...
            <div class="kb-factors">
              <div class="kb-factor"><span class="kb-factor-ic">↑</span><div><div class="kb-factor-name">Тип перехода</div><div class="kb-factor-note">Сварные крупного DN (ОСТ) и точеные детали СТО дороже бесшовных ГОСТ 17378-2001 при сопоставимых DN за счёт трудоёмкости.</div></div></div>
