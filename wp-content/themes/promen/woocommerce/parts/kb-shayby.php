...
<!-- S10: БАЗА ЗНАНИЙ — КРЕПЁЖ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">KNOWLEDGE BASE / ШАЙБЫ</div>
    </div>
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        <div class="kb-lead">
          ...
          <p class="kb-lead-p">Шайбы — <strong>98 позиций</strong> (ГОСТ 6402 и усиленные ГОСТ 11371). Комплектуют болтовые и шпилечные соединения. Подбор по <strong>резьбе M</strong> и <strong>длине L</strong> (где применимо), классу прочности и ГОСТ/ОСТ.</p>
        </div>
