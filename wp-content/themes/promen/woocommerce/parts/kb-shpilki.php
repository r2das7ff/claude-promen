...
<!-- S10: БАЗА ЗНАНИЙ — КРЕПЁЖ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">ШПИЛЬКИ</div>
    </div>

    <div class="kb-tabrow" role="tablist">
      <button class="kb-tab active" data-panel="types" role="tab"><span class="kb-tab-n">01</span>Виды — шпильки</button>
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        <div class="kb-lead">
          <div class="kb-lead-h">Классификация — шпильки</div>
          <p class="kb-lead-p">Шпильки — <strong>3&nbsp;012 позиций</strong>: общепромышленные, фланцевые и ОСТ для сосудов/аппаратов. Типовое исполнение фланцевого крепежа. Подбор по <strong>резьбе M</strong> и <strong>длине L</strong> (где применимо), классу прочности и ГОСТ/ОСТ.</p>
        </div>
      ...
      <div class="kb-panel" id="kp-params">
        ...
        <div class="kb-2col">
          <div>
            <div class="kb-col-title">Чеклист заявки на шпильки</div>
      ...
      <div class="kb-panel" id="kp-order">
        <div class="kb-3col">
          <div>
            <div class="kb-col-title">Как подготовить заявку на шпильки</div>
            <div class="kb-checklist">
