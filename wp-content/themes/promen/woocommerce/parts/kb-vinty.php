...
<!-- S10: БАЗА ЗНАНИЙ — КРЕПЁЖ -->
  <section class="s kb-wrap" id="s10">
    <div class="s-hd">
      ...
      <div class="s-meta">KNOWLEDGE BASE / ВИНТЫ</div>
    </div>
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        <div class="kb-lead">
          ...
          <p class="kb-lead-p">Винты — <strong>1 позиция</strong> по ГОСТ 6958-1978 в текущем реестре. Расширение ряда — по КД заказчика. Подбор по <strong>резьбе M</strong> и <strong>длине L</strong> (где применимо), классу прочности и ГОСТ/ОСТ.</p>
        </div>
