  ...
  <div class="kb-panels">
      ...
      <div class="kb-2col">
        <div>
          ...
          <div class="kb-doclist">
            ...
            <div class="kb-doc-item"><div class="kb-doc-name">Сертификат ТР ТС 032/2013</div><div class="kb-doc-desc">При работе под избыточным давлением свыше 0,05 МПа.</div></div>
          </div>
        </div>
        <div>
    ...
    <div class="kb-panel" id="kp-delivery">
      ...
      <div class="kb-cards">
        ...
        <div class="kb-card"><div class="kb-card-badge">САМОВЫВОЗ</div><div class="kb-card-title">Челябинск</div><p class="kb-card-body">454091, ул. Орджоникидзе, 37. Пн–Пт 08:00–17:00.</p></div>
