 ...
 * разметка — классы category-sdt.css; факты — aggregates / ГОСТ 17379-2001, 22815-83.
  ...
  <section class="s kb-wrap" id="s10">
    ...
    <div class="kb-panels">
      ...
      <div class="kb-panel kp-active" id="kp-types">
        ...
        <div class="kb-cards">
          <div class="kb-card">
            <div class="kb-card-badge">ГОСТ 17379-2001</div>
          ...
          <div class="kb-card">
            <div class="kb-card-badge">ГОСТ 22815-83</div>
          ...
          <div class="kb-card">
            ...
            <p class="kb-card-body">Эллиптическая форма снижает концентрацию напряжений на торце. Приваривается к трубе; область применения — в соответствии с разделом 1 ГОСТ 17380-2001 (общие ТУ на бесшовные приварные детали). Исполнения 1 и 2 — по таблицам размеров стандарта.</p>
            <div class="kb-card-tags"><span class="kb-tag">Приварные</span><span class="kb-tag">Исп. 1 / 2</span><span class="kb-tag">ГОСТ 17380-2001</span></div>
          </div>
          <div class="kb-card">
        ...
        <div class="kb-groups" style="grid-template-columns:repeat(2,1fr);">
          <div class="kb-grp">
            ...
            <span class="kb-grp-items">Приварные · ГОСТ 17379-2001 · 93 поз.</span>
          </div>
          <div class="kb-grp">
            <span class="kb-grp-code">ЗФ</span>
            <span class="kb-grp-name">Фланцевые · DN 6–200</span>
            <span class="kb-grp-items">Ру св. 10 до 100 МПа · ГОСТ 22815-83 · 35 поз.</span>
          </div>
        </div>
      </div>
        ...
        <div class="kb-2col">
          <div>
            ...
            <div class="kb-checklist">
              <div class="kb-check"><span class="kb-check-n">01</span><div><div class="kb-check-title">Тип: ЗЭ или ЗФ</div><div class="kb-check-body"><strong>Эллиптическая приварная</strong> (ГОСТ 17379-2001) или <strong>фланцевая</strong> (ГОСТ 22815-83, Ру до 100 МПа).</div></div></div>
          ...
          <div>
            ...
            <div class="kb-params">
              ...
              <div class="kb-param"><div class="kb-param-key">Исполнение</div><div class="kb-param-val">ЗЭ: исп. 1 / 2 (таблицы ГОСТ 17379-2001). ЗФ: исп. 1–4 фланца (таблицы ГОСТ 22815-83).</div></div>
        ...
        <div class="kb-norm-grid">
          <div class="kb-norm-group">
            ...
            <div class="kb-norm-items">
              ...
              <div class="kb-norm-item"><span class="kb-norm-code">ГОСТ 22815-83</span><span class="kb-norm-desc">Заглушки фланцевые на Ру свыше 10 до 100 МПа. Конструкция и размеры. 35 позиций, DN 6–200</span></div>
      ...
      <div class="kb-panel" id="kp-materials">
        <p class="kb-intro-p">В каталоге заглушек — <strong>шесть марок стали</strong>: пять доступны на всём ряде из 128 типоразмеров, теплоустойчивая <strong>20Х3МВФ</strong> — на серии фланцевых ГОСТ 22815-83 (35 позиций). <strong>Каждая марка поставляется с сертификатом качества 3.1</strong> (ГОСТ ISO 10474-2016) с плавочными данными, химическим составом и механическими характеристиками. Прослеживаемость металла от плавки до готовой заглушки фиксируется документально.</p>
        <div class="kb-mat-grid">
          ...
          <div class="kb-mat">
            ...
            <div class="kb-mat-range">Ру до 100 МПа · ГОСТ 22815-83</div>
      ...
      <div class="kb-panel" id="kp-order">
        <div class="kb-3col">
          <div>
            ...
            <div class="kb-checklist">
              <div class="kb-check"><span class="kb-check-n">01</span><div><div class="kb-check-title">Наименование и норматив</div><div class="kb-check-body">Заглушка эллиптическая по <strong>ГОСТ 17379-2001</strong> или фланцевая по <strong>ГОСТ 22815-83</strong>. Если норматив неизвестен — укажите DN, способ присоединения и давление.</div></div></div>
          ...
          <div>
            ...
            <div class="kb-factors">
              <div class="kb-factor"><span class="kb-factor-ic">↑</span><div><div class="kb-factor-name">Тип заглушки</div><div class="kb-factor-note">Фланцевые Ру 100 (ГОСТ 22815-83) дороже эллиптических приварных при сопоставимых DN за счёт конструкции и материала.</div></div></div>
          ...
          <div>
            ...
            <div class="kb-errors">
              ...
              <div class="kb-err"><span class="kb-err-ic">!</span><div><div class="kb-err-title">DN ≠ наружный диаметр трубы</div><div class="kb-err-note">Для DN 50 наружный диаметр по ГОСТ 8732-78 = 57 мм. Для ЗЭ всегда уточняйте D×s трубы.</div></div></div>
              <div class="kb-err"><span class="kb-err-ic">!</span><div><div class="kb-err-title">Заказать ГОСТ 17379-2001 при Ру 100</div><div class="kb-err-note">Высокое давление (свыше 10 МПа) — серия ГОСТ 22815-83 (фланцевые), не эллиптический общепром.</div></div></div>
      ...
      <div class="kb-panel" id="kp-delivery">
        ...
        <div class="kb-cards">
          ...
          <div class="kb-card">
            ...
            <p class="kb-card-body">454091, г. Челябинск, ул. Орджоникидзе, 37. Отгрузка в рабочие дни 08:00–17:00 после уведомления о готовности. Погрузка силами завода.</p>
            <div class="kb-card-tags"><span class="kb-tag">Пн–Пт 08:00–17:00</span><span class="kb-tag">Погрузка заводом</span></div>
          </div>
          <div class="kb-card">
