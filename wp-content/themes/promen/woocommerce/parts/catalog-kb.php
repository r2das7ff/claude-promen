  ...
  <div class="kb-panels">
      ...
      <div class="kb-norm-grid">
        ...
        <div class="kb-norm-group">
          ...
          <div class="kb-norm-items">
            ...
            <div class="kb-norm-item"><span class="kb-norm-code">ТР ТС 032/2013</span><span class="kb-norm-desc">О безопасности оборудования под избыточным давлением. Обязателен при PN &gt; 0,05 МПа. Серт. RU С-RU.АБ53.В.08323/23</span></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="kb-2col">
        <div>
          ...
          <div class="kb-doclist">
            ...
            <div class="kb-doc-item"><div class="kb-doc-name">Сертификат ТР ТС 032/2013 <span class="kb-doc-badge">Обязательно</span></div><div class="kb-doc-desc">RU С-RU.АБ53.В.08323/23. Подтверждение соответствия обязательно при PN &gt; 0.05 МПа для всей продукции в ЕАЭС.</div></div>
          </div>
        </div>
        <div>
    ...
    <div class="kb-panel" id="kp-faq">
      ...
      <div class="faq-wrap">
        ...
        <div class="fq"><div class="fq-q"><span class="fq-num">05</span><span class="fq-t">Нужен ли сертификат ТР ТС 032/2013 для всех позиций каталога?</span><span class="fq-arr">↓</span></div><div class="fq-a"><div class="fq-a-in">Да, для оборудования с <strong>PN &gt; 0.05 МПа</strong> подтверждение соответствия обязательно при вводе в эксплуатацию в ЕАЭС. Вся продукция завода охвачена сертификатом <strong>RU С-RU.АБ53.В.08323/23</strong> по ТР ТС 032/2013. Копия включается в комплект документов на каждую поставку независимо от группы изделия.</div></div></div>
