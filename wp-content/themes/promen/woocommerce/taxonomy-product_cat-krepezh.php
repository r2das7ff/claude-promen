...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / KREPEZH</div>
    </div>
    <div class="reg-bar" id="regBar">
      <span class="rb-lbl">Типоисполнения</span>
      <span class="rb-lbl" style="opacity:.55;">5 групп · клик по заголовку сворачивает группу</span>
      <span class="rb-count" id="regCount">5 типов · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="b">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">Б</span>
          <span class="rg-name">Болты<small>фундаментные · шестигранные · высокопрочные</small></span>
          <span class="rg-params">M × L · 10 467 поз.</span>
          <span class="rg-cnt">10 467 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22032-1976', $otv_url ) ); ?>">
        <span class="rr-i">КРП-22032</span>
        <span class="rr-n">Болт фундаментный<small>тип · ГОСТ 22032</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">2 301 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 22032-1976</span>
        <span class="rr-t"><span class="rr-tag hi">Фундамент</span><span class="rr-tag">Монтаж</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7805-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-7805</span>
        <span class="rr-n">Болт с уменьшенной головкой<small>ГОСТ 7805</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">1 936 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 7805-1970</span>
        <span class="rr-t"><span class="rr-tag hi">Общепром.</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-22043-1976', $otv_url ) ); ?>">
        <span class="rr-i">КРП-22043</span>
        <span class="rr-n">Болт фундаментный<small>ГОСТ 22043</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">1 588 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 22043-1976</span>
        <span class="rr-t"><span class="rr-tag hi">Фундамент</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7798-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-7798</span>
        <span class="rr-n">Болт с шестигранной головкой<small>ГОСТ 7798</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">1 512 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 7798-1970</span>
        <span class="rr-t"><span class="rr-tag hi">Фланцы</span><span class="rr-tag">Общепром.</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-7795-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-7795</span>
        <span class="rr-n">Болт с шестигранной головкой<small>ГОСТ 7795</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">1 080 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 7795-1970</span>
        <span class="rr-t"><span class="rr-tag">Общепром.</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10602-1994', $otv_url ) ); ?>">
        <span class="rr-i">КРП-10602</span>
        <span class="rr-n">Болт высокопрочный<small>ГОСТ 10602</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">242 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 10602-1994</span>
        <span class="rr-t"><span class="rr-tag hi">Высокопрочн.</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="shp">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ШП</span>
          <span class="rg-name">Шпильки<small>фланцевые · общепромышленные · ОСТ</small></span>
          <span class="rg-params">M × L · 3 012 поз.</span>
          <span class="rg-cnt">3 012 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-15590-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-15590</span>
        <span class="rr-n">Шпилька<small>ГОСТ 15590</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">1 505 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 15590-1970</span>
        <span class="rr-t"><span class="rr-tag hi">Фланцы</span><span class="rr-tag">ТЭС</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-9066-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-9066</span>
        <span class="rr-n">Шпилька для фланцевых соединений<small>ГОСТ 9066</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">662 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 9066-1970</span>
        <span class="rr-t"><span class="rr-tag hi">Фланцы</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'ost-26-2040-96', $otv_url ) ); ?>">
        <span class="rr-i">КРП-2040</span>
        <span class="rr-n">Шпилька ОСТ<small>ОСТ 26-2040</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">398 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ОСТ 26-2040-96</span>
        <span class="rr-t"><span class="rr-tag hi">Сосуды</span><span class="rr-tag">Аппараты</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10494-1980', $otv_url ) ); ?>">
        <span class="rr-i">КРП-10494</span>
        <span class="rr-n">Шпилька<small>Ст20 · ГОСТ 10494</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">207 поз.</span>
        <span class="rr-m">Ст20</span>
        <span class="rr-g">ГОСТ 10494-1980</span>
        <span class="rr-t"><span class="rr-tag">Ст20</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="g">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">Г</span>
          <span class="rg-name">Гайки<small>шестигранные · фланцевые · колпачковые</small></span>
          <span class="rg-params">M · 168 поз.</span>
          <span class="rg-cnt">168 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-9064-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-9064</span>
        <span class="rr-n">Гайка для фланцевых соединений<small>ГОСТ 9064</small></span>
        <span class="rr-dn">M</span>
        <span class="rr-pn">26 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 9064-1970</span>
        <span class="rr-t"><span class="rr-tag hi">Фланцы</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5915-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-5915</span>
        <span class="rr-n">Гайка шестигранная<small>ГОСТ 5915</small></span>
        <span class="rr-dn">M</span>
        <span class="rr-pn">22 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 5915-1970</span>
        <span class="rr-t"><span class="rr-tag">Общепром.</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="sh">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">Ш</span>
          <span class="rg-name">Шайбы<small>пружинные · усиленные</small></span>
          <span class="rg-params">M · 98 поз.</span>
          <span class="rg-cnt">98 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6402-1970', $otv_url ) ); ?>">
        <span class="rr-i">КРП-6402</span>
        <span class="rr-n">Шайба<small>ГОСТ 6402</small></span>
        <span class="rr-dn">M</span>
        <span class="rr-pn">80 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 6402-1970</span>
        <span class="rr-t"><span class="rr-tag">Фланцы</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-11371-1978', $otv_url ) ); ?>">
        <span class="rr-i">КРП-11371</span>
        <span class="rr-n">Шайба усиленная<small>ГОСТ 11371</small></span>
        <span class="rr-dn">M</span>
        <span class="rr-pn">18 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 11371-1978</span>
        <span class="rr-t"><span class="rr-tag">Усиленная</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="v">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">В</span>
          <span class="rg-name">Винты<small>по ГОСТ 6958</small></span>
          <span class="rg-params">1 поз.</span>
          <span class="rg-cnt">1 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6958-1978', $otv_url ) ); ?>">
        <span class="rr-i">КРП-6958</span>
        <span class="rr-n">Винт<small>ГОСТ 6958</small></span>
        <span class="rr-dn">—</span>
        <span class="rr-pn">1 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 6958-1978</span>
        <span class="rr-t"><span class="rr-tag">Монтаж</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр крепежа →</a>
    </div>
  </section>
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'krepezh' ); ?>
