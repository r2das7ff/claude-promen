<?php
/**
 * Страница категории «Днища» — шаблон sdt.html второго уровня.
 * Сгенерирована по PLAYBOOK-CATEGORY.md; факты — aggregates / ГОСТ 6533-78.
 */
...
$otv      = get_term_by( 'slug', 'dnishcha', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'dnishcha', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / DNISHCHA</div>
    </div>
    <div class="reg-bar" id="regBar">
      <span class="rb-lbl">Типоисполнения</span>
      <span class="rb-lbl" style="opacity:.55;">1 группа · клик по заголовку сворачивает группу</span>
      <span class="rb-count" id="regCount">1 серия · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="de">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ДЭ</span>
          <span class="rg-name">Эллиптические отбортованные<small>для сосудов, аппаратов и котлов</small></span>
          <span class="rg-params">DN 100–3800 · s 4–90</span>
          <span class="rg-cnt">250 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6533-1978', $otv_url ) ); ?>">
        <span class="rr-i">ДНЩ-001</span>
        <span class="rr-n">Днище эллиптическое отбортованное<small>основные размеры по ГОСТ 6533</small></span>
        <span class="rr-dn">100–3800</span>
        <span class="rr-pn">250 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 6533-1978</span>
        <span class="rr-t"><span class="rr-tag hi">Сосуды</span><span class="rr-tag">Котлы</span></span>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр днищ →</a>
    </div>
  </section>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <div class="sg-tags">
              <span class="sg-tag hi">ГОСТ 6533-78</span><span class="sg-tag">тип ДЭ</span><span class="sg-tag">250 позиций</span>
            </div>
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6533-1978', $otv_url ) ); ?>">К днищам в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <div class="sg-tags">
              <span class="sg-tag hi">ГОСТ 6533-78</span><span class="sg-tag">DN 1400–3800</span><span class="sg-tag">71 позиция</span>
            </div>
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-6533-1978', $otv_url ) ); ?>">К крупным в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( $otv_url ); ?>">К реестру днищ →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'dnishcha' ); ?>
...
<?php include __DIR__ . '/parts/kb-dnishcha.php'; ?>
