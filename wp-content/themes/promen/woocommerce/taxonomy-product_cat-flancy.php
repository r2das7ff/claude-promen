<?php
/**
 * Страница категории «Фланцы» — шаблон sdt.html второго уровня.
 * Отдельная ветка /catalog/flancy/. Факты — aggregates / ГОСТ 33259, 12820, 12821, 28759.2.
 */
...
$otv      = get_term_by( 'slug', 'flancy', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'flancy', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / FLANCY</div>
    </div>
    <div class="reg-bar" id="regBar">
      ...
      <span class="rb-count" id="regCount">4 серии · <?php echo esc_html( number_format_i18n( $otv_cnt ) ); ?> позиций</span>
    </div>
    <div class="reg-hd">
    ...
    <div id="regList">
      <div class="reg-group open" data-group="t11">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">11</span>
          <span class="rg-name">Воротниковые тип 11<small>приварные встык · ГОСТ 33259</small></span>
          <span class="rg-params">DN 10–2400 · PN до 250</span>
          <span class="rg-cnt">273 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-33259-2015', $otv_url ) ); ?>">
        <span class="rr-i">ФЛН-33259</span>
        <span class="rr-n">Фланец тип 11<small>воротниковый · PN до 250</small></span>
        <span class="rr-dn">10–2400</span>
        <span class="rr-pn">273 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 33259-2015</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">НГК</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="t01">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">01</span>
          <span class="rg-name">Плоские тип 01<small>ГОСТ 33259 · PN до 250</small></span>
          <span class="rg-params">DN 10–2400 · тип 01</span>
          <span class="rg-cnt">139 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-33259-2015', $otv_url ) ); ?>">
        <span class="rr-i">ФЛН-33259</span>
        <span class="rr-n">Фланец тип 01<small>плоский · PN до 250</small></span>
        <span class="rr-dn">10–2400</span>
        <span class="rr-pn">139 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 33259-2015</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">Общепром.</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="fp">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ФП</span>
          <span class="rg-name">Плоские приварные<small>трубопроводные и сосудовые</small></span>
          <span class="rg-params">DN 10–4000 · ФП</span>
          <span class="rg-cnt">211 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-12820-1980', $otv_url ) ); ?>">
        <span class="rr-i">ФЛН-12820</span>
        <span class="rr-n">Фланец плоский приварной<small>Ру 0,1–2,5 МПа</small></span>
        <span class="rr-dn">10–1200</span>
        <span class="rr-pn">111 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 12820-1980</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">Теплосети</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-28759-2-2022', $otv_url ) ); ?>">
        <span class="rr-i">ФЛН-28759</span>
        <span class="rr-n">Фланец сосудовый плоский<small>аппараты · ГОСТ 28759.2</small></span>
        <span class="rr-dn">400–4000</span>
        <span class="rr-pn">100 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 28759.2-2022</span>
        <span class="rr-t"><span class="rr-tag hi">Сосуды</span><span class="rr-tag">Аппараты</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
      </div>
      <div class="reg-group open" data-group="fv">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          <span class="rg-code">ФВ</span>
          <span class="rg-name">Воротниковые приварные встык<small>ГОСТ 12821</small></span>
          <span class="rg-params">DN 10–350 · Ру до 20 МПа</span>
          <span class="rg-cnt">32 поз.</span>
          <span class="rg-chev"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
        </button>
        <div class="reg-group-body">
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-12821-1980', $otv_url ) ); ?>">
        <span class="rr-i">ФЛН-12821</span>
        <span class="rr-n">Фланец приварной встык<small>воротниковый · Ру до 20 МПа</small></span>
        <span class="rr-dn">10–350</span>
        <span class="rr-pn">32 поз.</span>
        <span class="rr-m">09Г2С, 12Х18Н10Т, 20</span>
        <span class="rr-g">ГОСТ 12821-1980</span>
        <span class="rr-t"><span class="rr-tag hi">ТЭС</span><span class="rr-tag">НГК</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр фланцев →</a>
    </div>
  </section>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-33259-2015', $otv_url ) ); ?>">К фланцам 33259 в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-12820-1980', $otv_url ) ); ?>">К плоским в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-12821-1980', $otv_url ) ); ?>">К воротниковым в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-28759-2-2022', $otv_url ) ); ?>">К сосудовым в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'flancy' ); ?>
...
<?php include __DIR__ . '/parts/kb-flancy.php'; ?>
