<?php
/**
 * Страница категории «Гайки» — семейство крепежа.
 * Ветка /catalog/krepezh/gayki/. Факты — aggregates / content/category/gayki.md.
 */
...
$otv      = get_term_by( 'slug', 'gayki', 'product_cat' );
$otv_url  = add_query_arg( 'group', 'gayki', $shop_url );
...
<section class="s s-alt" id="s01">
    <div class="s-hd">
      ...
      <div class="s-meta">PRODUCT REGISTRY / GAYKI</div>
    </div>
    ...
    <div id="regList">
      <div class="reg-group open" data-group="main">
        <button class="reg-group-hd" type="button" aria-expanded="true">
          ...
          <span class="rg-name">Гайки<small>семейство крепежа</small></span>
          <span class="rg-params">M × L · 168 поз.</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10605-1994', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-10605</span>
        <span class="rr-n">Гайка шестигранная<small>ГОСТ 10605</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 10605-1994</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-10607-1994', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-10607</span>
        <span class="rr-n">Гайка шестигранная низкая<small>ГОСТ 10607</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 10607-1994</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5915-1970', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-5915</span>
      ...
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5916-1970', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-5916</span>
        <span class="rr-n">Гайка шестигранная низкая<small>ГОСТ 5916</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 5916-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5927-1970', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-5927</span>
        <span class="rr-n">Гайка с уменьшенным размером под ключ<small>ГОСТ 5927</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 5927-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
      <a class="reg-r" data-type="otv" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5929-1970', $otv_url ) ); ?>">
        <span class="rr-i">ГАЙ-5929</span>
        <span class="rr-n">Гайка колпачковая<small>ГОСТ 5929</small></span>
        <span class="rr-dn">M×L</span>
        <span class="rr-pn">24 поз.</span>
        <span class="rr-m">по стандарту</span>
        <span class="rr-g">ГОСТ 5929-1970</span>
        <span class="rr-t"><span class="rr-tag hi">КР</span></span>
        <span class="rr-arr">›</span>
      </a>
        </div>
    ...
    <div class="reg-cta">
      <a class="s10-submit" href="<?php echo esc_url( $otv_url ); ?>" style="display:inline-flex;">Открыть полный реестр — гайки →</a>
      ...
      <div class="sel-guide reveal">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-9064-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5915-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
        ...
        <div class="sg-row">
          ...
          <div class="sg-product">
            ...
            <a class="sg-link" href="<?php echo esc_url( add_query_arg( 'gost', 'gost-5916-1970', $otv_url ) ); ?>">К позициям в реестре →</a>
          </div>
          <div class="sg-params">
            <div class="sg-param-list">
...
<?php promen_render_norm_base( is_tax() ? get_queried_object()->slug : 'gayki' ); ?>
...
<?php include __DIR__ . '/parts/kb-gayki.php'; ?>
