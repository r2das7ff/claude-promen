...
<div class="pg">
  ...
  <!-- MEDIA -->
  <div class="ar-media">
    <picture><source srcset="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-6.webp' ) ); ?>" type="image/webp"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-6.jpg' ) ); ?>" alt="Контроль качества на производстве" loading="eager" width="1125" height="2000"></picture>
