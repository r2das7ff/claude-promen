...
<div class="pg">
  ...
  <!-- MEDIA -->
  <div class="ar-media">
    <picture><source srcset="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-hor-1.webp' ) ); ?>" type="image/webp"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/photos/promen-photo-hor-1.jpg' ) ); ?>" alt="Стальные конструкции производственного цеха" loading="eager" width="1333" height="2000"></picture>
  ...
  <div class="ar-split">
    <article class="ar-content">
      ...
      <div class="ar-table">
        <div class="ar-row"><span class="k">Углеродистые / низколегированные</span><span class="v">09Г2С (−70…+475°C), Ст20 (до +425°C) — трубопроводы низкого и среднего давления, без агрессивных сред.</span></div>
        <div class="ar-row"><span class="k">Жаропрочные легированные</span><span class="v">12Х1МФ (до +585°C) — паропроводы ТЭС; 15Х5М (до +650°C) — нефтехимия. Длительная работа под давлением при высокой температуре.</span></div>
        <div class="ar-row"><span class="k">Нержавеющие аустенитные</span><span class="v">08Х18Н10Т, 12Х18Н10Т (до +600°C) — АЭС-класс, агрессивные и особо чистые среды, прослеживаемость плавки.</span></div>
      </div>

      <h3>Марки, применяемые в соединительных деталях</h3>
      <p>Сортамент завода по группе СДТ — с рабочими температурами и предельным давлением по нормативу. Таблица собирается из того же справочника, что и карточки каталога, поэтому расходиться они не могут.</p>
<?php promen_steel_table( 'sdt' ); ?>
      ...
      <p>Как только температура среды переваливает за +425…+475°C — предел углеродистых и низколегированных марок — в дело вступают легированные жаропрочные стали. 12Х1МФ (до +585°C по ГОСТ 20072-74) — стандарт для паропроводов высокого давления: добавки хрома, молибдена и ванадия замедляют ползучесть металла под длительной нагрузкой. Ещё выше по температуре работает 15Х5М (до +650°C), но её область — не энергетика, а нефтехимические установки: повышенное содержание хрома даёт стойкость к сероводородной и нафтеновой коррозии.</p>
      ...
      <p>Для объектов АЭС-класса, как например поставки на <a href="<?php echo esc_url( promen_project_url( 'kurskaya-aes' ) ); ?>">Курскую АЭС‑2</a>, к марке стали добавляется требование полной прослеживаемости плавки — от сертификата на металл до маркировки готового изделия. Подробнее о том, как это устроено на производстве, — в статье о <a href="<?php echo esc_url( promen_article_url( 'kontrol-kachestva' ) ); ?>">контроле качества СДТ</a>.</p>
      ...
      <ol>
        ...
        <li><strong>Технология изготовления.</strong> Не каждая сталь одинаково хорошо ведёт себя при штамповке или сварке — см. статью о <a href="<?php echo esc_url( promen_article_url( 'otvod-svarnoy-besshovnyy' ) ); ?>">бесшовных и сварных отводах</a>.</li>
