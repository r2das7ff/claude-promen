...
`products-csv/new_products_from_az/az/detali_truboprovoda_master.csv`
весит 95 MB при жёстком лимите GitHub в 100 MB. Если файл дорастёт —
push заблокируется, и его придётся переводить в LFS с перезаписью
истории.
